...
public class Asyn_Http {
	...
	public Object[] connect(String strUrl, int repeat) {
		...
		try {
			...
			if(s.endsWith(".css") || s.endsWith(".js") || s.endsWith(".rar") ||s.endsWith(".xml")
				||s.endsWith(".doc") || s.endsWith(".docx") || s.endsWith(".pdf") ||s.endsWith(".jpg")
			    ||s.endsWith(".xls") || s.endsWith(".xlsx") || s.endsWith(".zip")) {
				Log.d(s);
				throw new Exception();
			}
